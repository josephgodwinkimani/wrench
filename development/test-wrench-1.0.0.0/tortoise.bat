echo executed tortoiseHg...
@echo off
Start ""  "C:\Program Files\TortoiseHg\thgw.exe"
REM starting TortoiseHg Workbench...
Start ""  "C:\Program Files\TortoiseHg\hg.exe"
REM starting Mercurial...
Start ""  "C:\Program Files\TortoiseHg\Pageant.exe"
REM starting Pageant client...
:command
